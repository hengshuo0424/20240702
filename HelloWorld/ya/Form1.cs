...
namespace NotePad
{
    public partial class Form1 : Form
    {
        ...
        private void btnOpen(object sender, MouseEventArgs e)
        {
            
        }


        private void btnSave(object sender, MouseEventArgs e)
        {
       
        }

        private void rtbText(object sender, MouseEventArgs e)
        {
